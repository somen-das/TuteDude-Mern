// D:\SOMEN\Self Practice\Nodejs\10.MongoDBConnect\controller\controler.js

const fs = require('fs');
const path = require('path')
const dataFilePath = path.join(__dirname, '../../9.MVC_Structure_backend/Data/new-todo-data.json')
...
const multipleDeleteData = (req, res)=>{
    const { ids } = req.body; 
